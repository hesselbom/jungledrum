(function e (t, n, r) { function s (o, u) { if (!n[o]) { if (!t[o]) { var a = typeof require === 'function' && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); var f = new Error("Cannot find module '" + o + "'"); throw f.code = 'MODULE_NOT_FOUND', f } var l = n[o] = {exports: {}}; t[o][0].call(l.exports, function (e) { var n = t[o][1][e]; return s(n ? n : e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require === 'function' && require; for (var o = 0; o < r.length; o++)s(r[o]); return s })({1: [function (require, module, exports) {
...
}, {'./helpers/api': 17, './helpers/page': 18, './helpers/template': 20, './history': 22, './store': 33, './views/app-view': 34, './views/login-view': 35, './views/no-page': 36, './views/page-view': 37, 'js-cookie': 46, 'preact': 59, 'preact-redux': 57, 'preact-router': 58}], 2: [function (require, module, exports) {
  'use strict'
...
}, {'classnames': 38, 'preact': 59, 'preact-router': 58}], 3: [function (require, module, exports) {
  'use strict'
...
}, {'preact': 59}], 4: [function (require, module, exports) {
  'use strict'
...
}, {'preact': 59}], 5: [function (require, module, exports) {
  'use strict'
...
}, {'../components/action-button': 2, 'preact': 59}], 6: [function (require, module, exports) {
  'use strict'
...
}, {'../helpers/api': 17, '../helpers/snackbars': 19, './action-button': 2, 'classnames': 38, 'preact': 59}], 7: [function (require, module, exports) {
  'use strict'
...
}, {'preact': 59}], 8: [function (require, module, exports) {
  'use strict'
...
}, {'../components/action-button': 2, 'preact': 59}], 9: [function (require, module, exports) {
  'use strict'
...
}, {'../components/action-button': 2, '../helpers/page': 18, 'preact': 59}], 10: [function (require, module, exports) {
  'use strict'
...
}, {'preact': 59}], 11: [function (require, module, exports) {
  'use strict'
...
}, {'../helpers/page': 18, 'preact': 59}], 12: [function (require, module, exports) {
  'use strict'
...
}, {'preact': 59}], 13: [function (require, module, exports) {
  'use strict'
...
}, {'preact': 59}], 14: [function (require, module, exports) {
  'use strict'
...
}, {'preact': 59}], 15: [function (require, module, exports) {
  'use strict'
...
}, {'preact': 59}], 16: [function (require, module, exports) {
  'use strict'
...
}, {'preact': 59}], 17: [function (require, module, exports) {
  'use strict'
...
}, {'js-cookie': 46}], 18: [function (require, module, exports) {
  'use strict'
  ...
  var _wysiwygInput = require('../components/wysiwyg-input')

  var _wysiwygInput2 = _interopRequireDefault(_wysiwygInput)
  ...
  function fetchPages (dispatch) {
    return fetch(GLOBALS.adminurl + '/api/pages', {
      ...
      return err.message === '401' ? dispatch({ type: 'LOGOUT' }) : null
    })
  }
  ...
  function getInput (field, value) {
    ...
    return (0, _utils.objSwitch)(field.type, {
      ...
      'wysiwyg': _preact2.default.h(_wysiwygInput2.default, {
        label: field.name,
        name: field.id,
        onChange: onInput,
        value: value
...
}, {'../components/checkbox-input': 3, '../components/custom-input': 4, '../components/file-input': 5, '../components/image-input': 8, '../components/input-list': 9, '../components/markdown-input': 10, '../components/object-input': 11, '../components/select-input': 12, '../components/text-input': 14, '../components/textarea-input': 15, '../components/wysiwyg-input': 16, '../helpers/api': 17, '../helpers/utils': 21, '../history': 22, './snackbars': 19, 'preact': 59}], 19: [function (require, module, exports) {
  'use strict'
...
}, {'../store': 33}], 20: [function (require, module, exports) {
  'use strict'
...
}, {'../helpers/api': 17}], 21: [function (require, module, exports) {
  'use strict'
...
}, {'history/createBrowserHistory': 43}], 23: [function (require, module, exports) {
  'use strict'
...
}, {'./editing': 23, './file': 24, './login': 26, './menu': 27, './page': 28, './pages': 29, './snackbars': 30, './templates': 31, './user': 32, 'redux': 66}], 26: [function (require, module, exports) {
  'use strict'
  ...
  exports.default = function () {
    ...
    switch (action.type) {
      ...
      case 'SET_PAGES':
        return _extends({}, action.pages.find(function (p) {
...
}, {'./reducers': 25, 'redux': 66}], 34: [function (require, module, exports) {
  'use strict'
  ...
  var view = function view (_ref) {
    ...
    var templatesAvailable = Object.keys(templates).length > 0
...
}, {'../components/action-button': 2, '../components/snack-bar': 13, 'js-cookie': 46, 'preact': 59, 'preact-redux': 57, 'preact-router': 58}], 35: [function (require, module, exports) {
  'use strict'
...
}, {'../components/action-button': 2, '../components/text-input': 14, '../helpers/page': 18, '../helpers/template': 20, 'js-cookie': 46, 'preact': 59, 'preact-redux': 57}], 36: [function (require, module, exports) {
  'use strict'
...
}, {'../components/hamburger-button': 7, 'preact': 59, 'preact-redux': 57}], 37: [function (require, module, exports) {
  'use strict'
  ...
  var PageView = (function (_Component) {
    ...
    */
      ...
      value: function populateCustomFields (page) {
        ...
        var templateKeys = Object.keys(this.props.templates)
        var templateKey = page._template || templateKeys[0]
        var template = this.props.templates[templateKey] || {}
      ...
      value: function setupCustomFields (props) {
        ...
        var templateKeys = Object.keys(props.templates)
        var templateKey = props.page._template || templateKeys[0]
        var template = props.templates[templateKey] || {}
        var fields = template.fields || []
        ...
        _preact2.default.h(
          ...
          templateKeys.length > 0 && !page._static ? _preact2.default.h(_selectInput2.default, {
            ...
            options: templateKeys.map(function (key) {
              return { value: key, label: templates[key].name || key }
            }),
            value: templateKey,
...
}, {'../components/action-button': 2, '../components/checkbox-input': 3, '../components/file-modal': 6, '../components/hamburger-button': 7, '../components/select-input': 12, '../components/text-input': 14, '../helpers/page': 18, 'preact': 59, 'preact-redux': 57}], 38: [function (require, module, exports) {
/*!
...
}, {'./PathUtils': 42, 'resolve-pathname': 68, 'value-equal': 72}], 42: [function (require, module, exports) {
  'use strict'
...
}, {'./DOMUtils': 39, './ExecutionEnvironment': 40, './LocationUtils': 41, './PathUtils': 42, './createTransitionManager': 44, '_process': 60, 'invariant': 45, 'warning': 73}], 44: [function (require, module, exports) {
  (function (process) {
    'use strict'
...
}, {'_process': 60, 'warning': 73}], 45: [function (require, module, exports) {
  (function (process) {
/**
...
}, {'preact': 59, 'redux': 66}], 58: [function (require, module, exports) {
  (function (global, factory) {
...
}, {'preact': 59}], 59: [function (require, module, exports) {
  !(function () {
    'use strict'
    function VNode () {}
    function h (nodeName, attributes) {
      ...
      while (stack.length) {
        if ((child = stack.pop()) && void 0 !== child.pop) for (i = child.length; i--;) stack.push(child[i]); else {
          if (simple = typeof nodeName !== 'function') if (typeof child === 'number') child = String(child); else if (child === !0 || child === !1 || child == null) child = ''; else if (typeof child !== 'string') simple = !1
    ...
    function enqueueRender (component) {
      if (!component.__d && (component.__d = !0) && items.push(component) == 1) (options.debounceRendering || setTimeout)(rerender)
    }
    function rerender () {
      var p, list = items
      items = []
    ...
    function isSameNodeType (node, vnode, hydrating) {
      if (typeof vnode === 'string' || typeof vnode === 'number') return void 0 !== node.splitText
      if (typeof vnode.nodeName === 'string') return !node._componentConstructor && isNamedNode(node, vnode.nodeName); else return hydrating || node._componentConstructor === vnode.nodeName
    }
    ...
    function setAccessor (node, name, old, value, isSvg) {
      ...
      if (name === 'key') ; else if (name === 'ref') {
        if (old) old(null)
        if (value) value(node)
      } else if (name === 'class' && !isSvg) node.className = value || ''; else if (name === 'style') {
        if (!value || typeof value === 'string' || typeof old === 'string') node.style.cssText = value || ''
        if (value && typeof value === 'object') {
          if (typeof old !== 'string') for (var i in old) if (!(i in value)) node.style[i] = ''
          for (var i in value) node.style[i] = typeof value[i] === 'number' && IS_NON_DIMENSIONAL.test(i) === !1 ? value[i] + 'px' : value[i]
        }
        ...
        if (value == null || value === !1) node.removeAttribute(name)
      } else {
        var ns = isSvg && name !== (name = name.replace(/^xlink\:?/, ''))
        if (value == null || value === !1) if (ns) node.removeAttributeNS('http://www.w3.org/1999/xlink', name.toLowerCase()); else node.removeAttribute(name); else if (typeof value !== 'object' && typeof value !== 'function') if (ns) node.setAttributeNS('http://www.w3.org/1999/xlink', name.toLowerCase(), value); else node.setAttribute(name, value)
      }
    }
    ...
    function diff (dom, vnode, context, mountAll, parent, componentRoot) {
      if (!diffLevel++) {
        isSvgMode = parent != null && void 0 !== parent.ownerSVGElement
    ...
    function idiff (dom, vnode, context, mountAll, componentRoot) {
      ...
      if (typeof vnode.nodeName === 'function') return buildComponentFromVNode(dom, vnode, context, mountAll)
      isSvgMode = vnode.nodeName === 'svg' ? !0 : vnode.nodeName === 'foreignObject' ? !1 : isSvgMode
      ...
      var fc = out.firstChild, props = out.q != null ? out.q : out.q = {}, vchildren = vnode.children
      if (!hydrating && vchildren && vchildren.length === 1 && typeof vchildren[0] === 'string' && fc != null && void 0 !== fc.splitText && fc.nextSibling === null) {
    ...
    function recollectNodeTree (node, unmountOnly) {
      ...
      if (component) unmountComponent(component); else {
        if (node.q != null && node.q.ref) node.q.ref(null)
        if (unmountOnly === !1 || node.q == null) node.remove()
        removeChildren(node)
      }
    }
    ...
    function diffAttributes (dom, attrs, old) {
      var name
      for (name in old) if ((!attrs || attrs[name] == null) && old[name] != null) setAccessor(dom, name, old[name], old[name] = void 0, isSvgMode)
    ...
    function setComponentProps (component, props, opts, context, mountAll) {
      if (!component.__x) {
        ...
        component.__x = !1
        if (opts !== 0) if (opts === 1 || options.syncComponentUpdates !== !1 || !component.base) renderComponent(component, 1, mountAll); else enqueueRender(component)
    ...
    function renderComponent (component, opts, mountAll, isChild) {
      if (!component.__x) {
        ...
        if (isUpdate) {
          ...
          if (opts !== 2 && component.shouldComponentUpdate && component.shouldComponentUpdate(props, state, context) === !1) skip = !0; else if (component.componentWillUpdate) component.componentWillUpdate(props, state, context)
          component.props = props
        ...
        if (component.__h != null) while (component.__h.length) component.__h.pop().call(component)
...
}, {'./createStore': 65, './utils/warning': 67, '_process': 60, 'lodash/isPlainObject': 56}], 64: [function (require, module, exports) {
  'use strict'
...
}, {'lodash/isPlainObject': 56, 'symbol-observable': 69}], 66: [function (require, module, exports) {
  (function (process) {
    'use strict'
